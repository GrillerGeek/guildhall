...
- **Haiku:** `refactorer` (Tink), `plugin-validator` (Tabs), `fog-cartographer` (Wren). Narrowly-scoped behavior-preserving refactors and mechanical regex / structural checks.
