...
Guildhall 0.10.0 can ask Jev to recommend a model for a specialist assignment.
...
quality improvements claimed for this release. The [verification report](reviews/2026-09-21-jev-routing.md)
...
Install or update [Guildhall](installation.md), then restart the host. Version
0.10.0 becomes available through `main` after merge. Normal skill use and off-mode
...
- [Off policy](../plugin/skills/guildhall-quest/resources/examples/off-policy.json)
- [Complete off request](../plugin/skills/guildhall-quest/resources/examples/off-request.json)
- [Policy schema](../plugin/skills/guildhall-quest/resources/schemas/policy.schema.json)
- [Request schema](../plugin/skills/guildhall-quest/resources/schemas/request.schema.json)
- [Host adapter and routing contract](../plugin/skills/guildhall-quest/references/routing.md)
...
bucket, required-capability count, objective, opaque candidate IDs and numeric
profile facts/compatibility booleans. Do not use identifying text in candidate
IDs. The request envelope names the requested Jev router model. It does not send
